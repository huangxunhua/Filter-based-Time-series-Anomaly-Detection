...
import os
import numpy as np
from sklearn.metrics import roc_curve, auc, average_precision_score, f1_score,classification_report,confusion_matrix,precision_recall_fscore_support,precision_recall_curve, recall_score
...
def evaluate(labels, scores,res_th=None, saveto=None):
    ...
    #return auc_prc,roc_auc,best_threshold,Pre,Recall,f1
